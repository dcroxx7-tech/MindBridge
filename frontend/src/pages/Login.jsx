...
export default function Login() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-background px-4 py-8 relative overflow-hidden">
      ...
      <div className="relative z-10 bg-white/[0.02] backdrop-blur-md w-full max-w-md p-6 sm:p-8 rounded-2xl border border-white/[0.06] shadow-2xl animate-slide-in animate-glow">
        
        <div className="stagger-in">
          {/* Brand Logo */}
          <div className="text-center mb-6">
            <div className="inline-flex p-3 bg-indigo-500/10 rounded-2xl mb-3 animate-float">
          ...
          {error && (
            <div className="bg-red-500/10 border border-red-500/20 text-red-400 p-3.5 rounded-xl text-xs sm:text-sm font-semibold mb-4 text-center animate-fade-in">
              {error}
            </div>
          )}
            ...
            {isSignUp && (
              <div className="space-y-1">
                ...
                <div className="relative group">
                  <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-slate-600 group-focus-within:text-indigo-400 transition-colors">
          ...
          <div className="mt-6 text-center border-t border-white/[0.04] pt-4">
            <button
              ...
              className="text-sm font-bold text-indigo-400 hover:text-indigo-300 hover:underline cursor-pointer transition-colors duration-200"
            >
              {isSignUp 
